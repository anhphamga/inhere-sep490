  ...
  const payload = {
    ...
    $push: {
      activityLogs: buildLogEntry({
        ...
        actorId,
        actorRole,
        note: `Cap nhat trang thai tu ${existing.status} sang ${status}`,
    ...
    { status: ALERT_STATUS.NEW },
    {
      ...
      $push: {
        activityLogs: buildLogEntry({
          ...
          actorId,
          actorRole,
          note: 'Danh dau da xem hang loat',
